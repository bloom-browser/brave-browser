...
const Config = function () {
  ...
  this.braveGoogleApiKey = getNPMConfig(['brave_google_api_key']) || 'AIzaSyDMM9Djfe4Erx3XBqLl1pjtRN382dA2XJY'
...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    if (!this.isOfficialBuild()) {
      ...
      args.chrome_public_manifest_package = 'com.bloom.browser_default'
    } else if (this.channel === '') {
      args.android_channel = 'stable'
      args.chrome_public_manifest_package = 'com.bloom.browser'
    } else if (this.channel === 'beta') {
      args.chrome_public_manifest_package = 'com.bloom.browser_beta'
    } else if (this.channel === 'dev') {
      args.chrome_public_manifest_package = 'com.bloom.browser_dev'
    } else if (this.channel === 'nightly') {
      args.android_channel = 'canary'
      args.chrome_public_manifest_package = 'com.bloom.browser_nightly'
    }
